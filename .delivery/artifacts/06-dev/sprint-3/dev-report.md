...
## Measured (CI run 35538774565, `--gate`, native, 10/10 valid, summary PASS; MiB median, one run, not a trend)
...
6. arm64 CPU model was not captured in the first run (cpuinfo has no model-name line); workflow now records CPU part too.
...
9. Only one CI run of the gate; variance across runs and runner types is unknown.
